...
After your PR is merged, a webhook notifies the website to sync your project's GitHub metadata (stars, issues, PRs, license, language). Your project card appears on the showcase within minutes.
